"""
Django settings for storyworth project.

Based on Heroku's example configuration:
...
# Enable ngrok for testing Twilio webhooks in development:
if DEBUG:
...
WSGI_APPLICATION = "storyworth.wsgi.application"
...
# Set correct mimetype for greeting audio file. Without this, Twilio doesn't
# transcode the audio properly and it comes through as garbled noise.
